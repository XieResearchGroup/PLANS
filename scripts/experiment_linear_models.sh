...
for i in {1..5}
do
    CUDA_VISIBLE_DEVICES=$1 python -m src.training.experiment_linear_models \
...
for i in {1..5}
do
    CUDA_VISIBLE_DEVICES=$1 python -m src.training.experiment_linear_model_w_outside_data \
    -p ./data/fromraw_cid_inchi_smiles_fp_labels_onehots.csv \
