...
#                                                             #
# The HMLC model is trained with partially labeled data or    #
# fully labeled data to compare the results.                  #
###############################################################
...
from .train_model import noisy_student, noisy_student_2
...
def main(data_path,
    ...
    # Model1
    log_f.write("The first teacher model is trained with fully labeled "
                "data only.")
    noisy_student(
        x_train=x_train,
        y_train=y_train,
    ...
    # Model2
    log_f.write("The first teacher model is trained with fully labeled and "
                "partially labeled data with the unlabeled loss set to 0.")
    noisy_student_2(
        x_train=x_train,
        y_train=y_train,
        unlabeled_weight=1,
