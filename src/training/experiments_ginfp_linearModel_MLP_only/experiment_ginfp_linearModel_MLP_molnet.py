...
class ExperimentLinearMLPGINFP(ExperimentBase):
    r""" Experiment that does not use Noisy Student method. Use GINFP as inputs.
    """
...
if __name__ == "__main__":
    ...
    experiment = ExperimentLinearMLPGINFP(
